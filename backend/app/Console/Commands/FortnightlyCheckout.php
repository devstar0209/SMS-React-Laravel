...
class FortnightlyCheckout extends Command
{
    /**
     ...
     * @var string
     */
    protected $signature = 'fortnightly:checkout';
     ...
     * @var string
     */
    protected $description = 'Checkout student fortnightly';
    ...
    {
        $studentpayments = StudentPayment::where('plan', 2)->where('method', '<>', 3)->get();
