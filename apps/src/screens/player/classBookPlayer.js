...
export default class ClassBookPlayerScreen extends React.Component {
  constructor(props) {
    super(props);
    this.state = {
      spinner: false,
      ...
      <View style={styles.container}>
        ...
        <View style={styles.tabs}>
          <TouchableOpacity style={[styles.tab, this.state.tabIndex == 0 ? { backgroundColor: '#E85763' } : { backgroundColor: '#ffffff' }]} onPress={() => this.onTab(0)}>
            <Text style={this.state.tabIndex === 0 ? { color: '#ffffff' } : { color: '#000000' }}>Sessions</Text>
          </TouchableOpacity>
          <TouchableOpacity style={[styles.tab, this.state.tabIndex == 1 ? { backgroundColor: '#E85763' } : { backgroundColor: '#ffffff' }]} onPress={() => this.onTab(1)}>
            <Text style={this.state.tabIndex === 1 ? { color: '#ffffff' } : { color: '#000000' }}>Booking Sessions</Text>
          </TouchableOpacity>
        </View>
