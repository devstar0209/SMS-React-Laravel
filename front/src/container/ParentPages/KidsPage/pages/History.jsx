...
import { requestStudentAttendance } from '../kidsactions'
...
const mapStateToProps = state => ({
    attendance_data: state.parentKidReducer.attendance,
    term: state.parentKidReducer.term,
    start_day: state.parentKidReducer.start_day,
})
