...
import { requestNewStudentPayment, requestStudentPayment, submitCheckout, submitPaymentOption, backDetail } from './../studentsactions'
...
const mapStateToProps = state => ({
    initialValues: state.studentReducer.student_payment
})
